      ...
      translation: {
        ...
        main: {
          ...
          auth: {
            ...
            'name-input-msg-length': 'name must be more than one letter',
            'name-input-msg-pattern': 'name must be in letters A-z',
            'login-input-required': 'Enter your login',
            'login-input-msg-length': 'name must be more than one letter',
      ...
      translation: {
        ...
        main: {
          ...
          auth: {
            ...
            'name-input-msg-length': 'Имя должно быть длиннее 1 буквы',
            'name-input-msg-pattern': 'Имя должно содержать только буквы A-z',
            'login-input-required': 'Введите логин',
            'login-input-msg-length': 'Логин должен быть длиннее 1 буквы',
